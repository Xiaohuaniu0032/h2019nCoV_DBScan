...
perl /data/fulongfei/git_repo/h2019nCoV_DBScan/scripts/parse_nextalign.pl /data/fulongfei/git_repo/h2019nCoV_DBScan/test/data2_results/nextalign.aligned.fasta /data/fulongfei/git_repo/h2019nCoV_DBScan/test/data2_results/input.concensus.fasta /data/fulongfei/git_repo/h2019nCoV_DBScan/reference/Ion_AmpliSeq_SARS-CoV-2-Insight.Reference.fa /usr/bin/samtools /data/fulongfei/git_repo/h2019nCoV_DBScan/test/data2_results/nextalign.insertions.csv /data/fulongfei/git_repo/h2019nCoV_DBScan/test/data2_results
