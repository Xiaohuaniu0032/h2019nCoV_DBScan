...
# 3. 一致性序列变异信息
```{r,include=FALSE}
datastat <- read.table("/tools/test/data2_results/vcMerged.xls",h=T)
```
...
# 4. 一致性序列变异信息总结
```{r,include=FALSE}
datastat <- read.table("/tools/test/data2_results/variants.summary.xls",h=T)
```
...
# 5. Top10最相似序列
```{r,include=FALSE}
datastat <- read.table("/tools/test/data2_results/similarity.based_on_variant_calling.top10.xls",h=T)
```
